...
import { Award, Users, Target, TrendingUp, Briefcase, Globe, Shield, Heart, Package, Mail, Phone, Linkedin } from 'lucide-react';
  ...
  const leadership = [
    {
      ...
      expertise: ["Strategic Leadership", "Business Development", "Market Expansion"],
  ...
  const departments = [
    {
      icon: <Briefcase />,
      title: "Operations",
      description: "Managing day-to-day operations, warehouse management, and quality control",
      teamSize: "15+ Members",
      color: "emerald"
    },
    {
      icon: <Globe />,
      title: "Supply Chain",
      description: "Coordinating international suppliers and ensuring timely deliveries",
      teamSize: "10+ Members",
      color: "teal"
    },
    {
      ...
      description: "Building relationships with clients and expanding market presence",
      teamSize: "8+ Members",
      color: "green"
    },
    {
      ...
      description: "Ensuring product quality and food safety standards compliance",
      teamSize: "6+ Members",
      color: "emerald"
    }
  ];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <div className="max-w-3xl">
            <div className="inline-block mb-6 px-4 py-2 bg-emerald-500/20 border border-emerald-500/50 rounded-full">
              <span className="text-emerald-400 text-sm font-semibold">MEET OUR TEAM</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              A dedicated team of professionals committed to delivering excellence in fresh produce distribution across Qatar and beyond.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-block mb-4 px-4 py-2 bg-emerald-100 rounded-full">
              <span className="text-emerald-700 text-sm font-semibold">LEADERSHIP</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
              Our Leadership Team
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Experienced leaders driving innovation and growth in the fresh produce industry
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-block mb-4 px-4 py-2 bg-emerald-100 rounded-full">
              <span className="text-emerald-700 text-sm font-semibold">OUR DEPARTMENTS</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
              Working Together
            </h2>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-block mb-4 px-4 py-2 bg-emerald-100 rounded-full">
                <span className="text-emerald-700 text-sm font-semibold">TEAM CULTURE</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
                Why Join Our Team?
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                At Tazej Global Trading, we believe in creating an environment where our team members can thrive, grow, and achieve their full potential.
              </p>
...
const LeadershipCard = ({ name, role, image, bio, expertise, email, phone }) => (
  <div className="group bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden">
    ...
    <div className="p-8 bg-gradient-to-br from-white to-gray-50">
      ...
      <div className="mb-6">
        <h4 className="text-sm font-bold text-slate-900 mb-3 uppercase tracking-wide">Areas of Expertise</h4>
  ...
  return (
    <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all border-2 border-gray-100 hover:border-emerald-500">
      <div className="flex items-start justify-between mb-6">
        <div className={`text-white bg-gradient-to-br ${colorClasses[color]} p-4 rounded-xl group-hover:scale-110 transition-transform`}>
