...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-500 ${scrolled ? 'bg-slate-900 shadow-2xl py-3' : 'bg-gradient-to-b from-slate-900/90 to-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center space-x-3">
            ...
            <div>
              <span className="text-2xl font-bold text-white block leading-tight">TAZEJ GLOBAL  <span className="text-sm md:text-xl pl-2 text-emerald-400 tracking-widest">تازج جلوبال  </span>   </span>
